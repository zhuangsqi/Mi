...
.btn-numbox {overflow: hidden;margin-top: 20px;}
.btn-numbox li {float: left;}
.btn-numbox li .number,.kucun {display: inline-block;font-size: 12px;color: #808080;vertical-align: sub;}
.btn-numbox .count {overflow: hidden;margin: 0 16px 0 -20px;}
				...
				<ul class="btn-numbox">
		            ...
		            <li>
		                <ul class="count">
		                    ...
		                    <li><input type="text" name="num" class="input-num" id="input-num" value="0" /></li>
