	...
	<table class="table table-border table-bordered table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$val->status}}</td>
				<td class="td-manage">
					<a title="编辑" href="auth/{{$val->id}}/edit"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont"></i></a> 
					<a title="删除" href="/auth/{{$val->id}}" onclick="admin_del(this,'1')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont"></i></a>
				</td>
			</tr>
			@endforeach
		</tbody>
