...
<div class="page-container">
	<form action="/admincates" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
    ...
    @endif
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="btn-upload form-group">
				<input class="input-text upload-url" type="text" name="img_url" id="img_url" readonly nullmsg="请添加附件！" style="width:200px">
