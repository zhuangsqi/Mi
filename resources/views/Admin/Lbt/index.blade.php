...
@section("main")
@section("title","轮播图列表")
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 轮播图管理 <span class="c-gray en">&gt;</span> 轮播图首页 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
		...
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					...
					<td>{{$row->code}}</td>
					<td>{{$row->url}}</td>
					<td><img src="/uploads/lbt/{{$row->pic}}" width="100px"></td>
					<td class="f-14">
